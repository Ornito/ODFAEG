...
namespace odfaeg {
    namespace core {
        ...
        template <size_t NB, typename T, bool B, size_t IH, size_t IH2, size_t N>
        struct remove_if_sames {

        };

        template <size_t NB, typename T, size_t IH1, size_t IH2, size_t N>
        ...
        template <size_t NB, typename T, size_t IH1, size_t N>
        ...
        template <typename T, size_t IH, bool B, bool B2>
        struct make_unique {
        ...
        template <size_t I, size_t J, class T, bool B>
        struct swap_if {
        };
        ...
        template <class Comp, typename T, size_t IH1, size_t IH2, size_t N>
        ...
        template <class Comp, typename T, size_t IH1, size_t N>
        ...
        template <typename Comp, typename T, size_t IH, bool B, bool B2>
        struct sort_impl {
        };
        template <typename Comp, typename T, size_t IH>
